  ...
  return (
    <>
        <div className="fixed md:top-10 top-14 w-screen h-[80vh] flex justify-center items-center">
            <div className="md:w-[600px] w-[280px] md:h-[300px] h-[420px] m-auto border-2 bg-slate-200 rounded-xl flex justify-around items-center relative md:flex-row flex-col">
                ...
                <div className="h-full w-full rounded-xl flex flex-col justify-center items-center hover:bg-slate-300 cursor-pointer">
                    <img src="https://uxwing.com/wp-content/themes/uxwing/download/computers-mobile-hardware/scan-icon.png" alt="scanner" className='h-28 bg-slate-300 p-3 rounded-xl' />
                ...
                <img src="https://uxwing.com/wp-content/themes/uxwing/download/e-commerce-currency-shopping/qr-code-scan-icon.png" alt="generator" className='h-28 bg-slate-300 p-3 rounded-xl' />
